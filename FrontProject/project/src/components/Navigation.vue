<template>
  <header :class="{'scrolled-nav': scroledlNav}">
  <nav>
    <div class="branding">
    ...
    <div class="icon">
      <i @click="toggleMobileNav" v-show="mobile" class="far fa-bars" :class="{'icon-acive':mobileNav}"></i>
    </div>
...
h1{
  ...
  text-shadow: 1px 1px 1px #030303, 1px 1px 2px #2980b9;
  margin-left: 25px;
