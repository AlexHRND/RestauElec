...
<v-col v-for="objs in resto.article">	<p><div class="product-content product-wrap clearfix">
  ...
  <div class="form-group">
    <label for="formGroupExampleInput">Nom de l'article actuel : {{objs.name}}</label>
  ...
  <div class="form-group">
    <label for="formGroupExampleInput2">Description actuelle : {{objs.description}}</label>
    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Nouvelle description">
  </div>
</form>
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-6"> 
							<a href="javascript:void(0);" class="btn btn-primary">Modifier les informations</a>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
						</div>
					</div>
